...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // No redirect for /articles/open-source-web-analytics: the old list
      // had one, but the article still exists and is in the sitemap, and
      // since that redirect never ran the article has stayed reachable.
      {
